...
!(async () => {
    ...
    let res = [];
    try{res = await getAuthorShareCode('https://xr2021.coding.net/p/import-kasd/d/JDbot/git/raw/master/shareCodes/shop.json');}catch (e) {}
    if(!res){
        try{res = await getAuthorShareCode('https://xr2021.coding.net/p/import-kasd/d/JDbot/git/raw/master/shareCodes/shop.json');}catch (e) {}
        if(!res){res = [];}
    }
    let res2 = [];
    try{res2 = await getAuthorShareCode('https://xr2021.coding.net/p/import-kasd/d/JDbot/git/raw/master/shareCodes/shop.json');}catch (e) {}
    if(!res2){
        try{res2 = await getAuthorShareCode('https://xr2021.coding.net/p/import-kasd/d/JDbot/git/raw/master/shareCodes/shop.json');}catch (e) {}
        if(!res2){res2 = [];}
    }
