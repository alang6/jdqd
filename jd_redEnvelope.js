...
function getCoupons(shareId = '') {
  return new Promise(resolve => {
    let options = {
      url: `https://api.m.jd.com/api?functionId=getCoupons&appid=u&_=${Date.now()}&loginType=2&body=${encodeURIComponent(JSON.stringify({"platform":4,"unionActId":"31134","actId":$.actId,"d":"3tVMzEv","unionShareId":shareId,"type":1,"eid":$.eid}))}&client=apple&clientVersion=8.3.6&h5st=undefined`,
      headers: {
        "Host": "api.m.jd.com",
...
function shareUnionCoupon() {
  return new Promise(resolve => {
    let options = {
      url: `https://api.m.jd.com/api?functionId=shareUnionCoupon&appid=u&_=${Date.now()}&loginType=2&body=${encodeURIComponent(JSON.stringify({"unionActId":"31134","actId":$.actId,"platform":4,"unionShareId":$.shareCode,"d":"3tVMzEv","supportPic":2,"supportLuckyCode":0,"eid":$.eid}))}&client=apple&clientVersion=8.3.6`,
      headers: {
        "Host": "api.m.jd.com",
        "Origin": "https://prodev.m.jd.com",
        "User-Agent": UA,
